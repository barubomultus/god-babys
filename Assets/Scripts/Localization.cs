...
public static class Localization
{
    ...
    static Localization()
    {
        ...
        Add("intro_サクラ", "天才外科医 / 手術成功率: 100%", "Genius Surgeon / Success Rate: 100%");
        Add("intro_ヒナタ", "暗殺拳の継承者 / 全戦全勝", "Heir of Assassination Arts / Undefeated");
        Add("intro_アキラ", "五輪金メダル7個 / 100m走: 10.1秒", "7 Olympic Golds / 100m: 10.1s");
        Add("intro_ミサト", "量子物理学者 / IQ: 270", "Quantum Physicist / IQ: 270");
        Add("intro_カエデ", "総資産: 28兆円 / 美容帝国CEO", "Net Worth: $280B / Beauty Empire CEO");
